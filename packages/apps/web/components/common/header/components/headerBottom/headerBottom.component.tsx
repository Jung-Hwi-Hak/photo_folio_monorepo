...
export default function HeaderBottomComponent() {
  const { scrollYS, setMode, darkMode, setClickState, clickState } = useHeaderBottomHooks();
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col flex-1">
          ...
          <dd className="text-mainText">
            <span className="cursor-pointer hover:text-[olivedrab]">Jung Hwi Hak ( FE )</span>
          </dd>
        </div>
